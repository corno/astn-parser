import * as td from "../interface/types/TestDefinition"
...
export const extensionTests: td.TestDefinitions = {
    ...
    "incomplete tagged union": {
        ...
        events: [
            ["token", "opentaggedunion", null],
            ["token", "simple string", "foo", null],
            ["parsingerror", "unexpected end of text, still in tagged union", null],
            ["end", null],
        ],
    },
    "incomplete tagged union in object": {
        ...
        events: [
            ...
            ["token", "opentaggedunion", null],
            ["token", "simple string", "foo", null],
            ["parsingerror", "missing tagged union value", null],
            ["token", "closeobject", null],
            ["end", null],
        ],
    },
