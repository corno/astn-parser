...
type BlockCommentContext = {
    locationOfFoundAsterisk: null | astn.Location
}
...
type FoundNewlineCharacter = {
    ...
    | ["carriage return", {}]
    | ["line feed", {}]
    startLocation: astn.Location
}

type NoneContext = {
    foundNewlineCharacter: pr.optional<FoundNewlineCharacter>
    foundSolidus: pr.optional<astn.Location>
}
...
function getCurrentCharacterRange(ls: ILocationState): astn.Range {
    return createRangeFromLocations(ls.getCurrentLocation(), ls.getNextLocation())
}

type OnError = ($: {
    error: astn.TokenError
    range: astn.Range
}) => void
                        ...
                        (nextChar) => {
                            ...
                            if ($.foundNewlineCharacter !== null) {
                                ...
                                switch (nextChar) {
                                    ...
                                    default: {
                                        function createStructuralToken(type: parser.StructuralTokenType): TokenReturnType {
                                            return {
                                                startSnippet: false,
                                                consumeCharacter: true,
                                                preToken: {
